...
class ListaEncadeada(object):
    ...
    def removeFirst(self):
        """Remove the first elemente of the chain list."""
    ...
    def append(self, valor):
        """Append a value at the end of the chain list."""
    ...
    def first(self):
        """Return the first element of the chain list."""
        if self.head is None:
            return None
        else:
            return self.head
    ...
    def last(self):
        """Return the last element of the chain list."""
        if self.head is None:
            return None
        else:
            return self.tail
    ...
    def pop(self):
        """Remove and return the last element of the chain list."""
        if self.head is None:
            return None
    ...
    def addFirst(self, valor):
        """Add a value in the first element of the chain list."""
        if self.head is None:
            self.append(valor)
        else:
            old = self.head
...
class No(object):
    """Define a node of the chain list."""
